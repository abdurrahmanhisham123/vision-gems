...
const generateMockData = (): BatchStone[] => {
  return Array.from({length: 25}).map((_, i) => ({
    id: `ru-bkk2-${i}`,
    code: `RB2-${String(i+1).padStart(3, '0')}`,
    weight: Number((0.7 + Math.random()).toFixed(2)),
    variety: 'Ruby',
        ...
        <div className="p-6 border-b border-stone-100 flex justify-between items-start bg-white sticky top-0 z-10">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-mono text-stone-400 bg-stone-100 px-1.5 py-0.5 rounded">RUBY BATCH 2</span>
            </div>
...
export const RuBkk2Template: React.FC<Props> = ({ tabId, isReadOnly }) => {
